    ...
    <div class="chat-header">
      <div class="header-left">
        ...
        <div class="header-info">
          <span class="bot-name">AquaBot</span>
      ...
      <div class="header-actions">
        <button class="icon-btn" title="Clear conversation" @click="clearChat">
          <svg viewBox="0 0 20 20" fill="none"><path d="M4 5h12M8 5V3h4v2M6 5l.8 11h6.4L14 5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
        </button>
      </div>
    </div>
...
.bubble.user {
  background: linear-gradient(135deg, var(--blue-1), #0052cc);
  color: #fff;
...
.edit-btn.save:hover { background: #0052cc; }
